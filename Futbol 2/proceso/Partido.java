...
public class Partido {
	...
	/*
	 * 	Constructor: Juega un partido entre los dos equipos que recibe. Resuelve qui�n gan� o si hubo
	 * 	empate. Cambia la local�a de los equipos que juegan.
	...
	/*
	 * 	Determina qu� jugadores anotaron los goles de un equipo.
	 * 	Por cada gol marcado genera un n�mero al azar del 0 al 100. A partir de ese n�mero
	 * 	determina si el gol fue marcado por el arquero (�ndice 0 del objeto List jugadores
	 * 	del equipo), un defensor (�ndices del 1 al 4), un volante (�ndices del 5 al 7) o un
	 * 	delantero (�ndices del 8 al 10) de acuerdo a probabilidades fijas.
	 * 	Luego genera un n�mero al azar que determina qu� jugador lo marc�. Finalmente agrega
	...
	/*
	 * 	Determina la cantidad de goles que marc� el equipo local. Recibe un entero
	...
	/*
	 * 	Determina la cantidad de goles que marc� el equipo visitante. Recibe un entero
	 * 	del 0 al 100 y setea los goles de acuerdo a probabilidades fijas. El equipo
	 * 	visitante tiene desventaja probabil�stica.
	 * 	Recibe: entero del 0 al 100.
	 */
